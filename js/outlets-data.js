...
const BK_OUTLETS = [
  ...
  },
  {
    ...
    lat: 11.108, lng: 77.341
  },
  {
    name: 'NRT Nagar (Theni)', city: 'Theni', state: 'Tamil Nadu', zone: 'south',
  ...
  {
    name: 'Indira Nagar (Adyar)', city: 'Chennai', state: 'Tamil Nadu', zone: 'south',
  ...
  },
  {
    ...
    address: 'Old No: 30, New No: 21, 1st Floor, Madras Food Walk, Arcot Road, Thirumurugan Nagar, Porur, Chennai, Tamil Nadu 600116',
    maps: 'https://maps.app.goo.gl/6ydpkrH1XCU5KPJY6', status: 'Open Now',
    lat: 13.035, lng: 80.155
  },
  {
    ...
    maps: 'https://share.google/OFH1MbNO6X53bAu89', status: 'Coming Soon',
  ...
  },
  {
    ...
    lat: 13.052, lng: 80.207
  },
  {
    name: 'Erode', city: 'Erode', state: 'Tamil Nadu', zone: 'south',
    address: '310 A, EVN Road, Surampatti Nall Road, Near Vallampuri Selva Vinayagar Temple, Erode, Tamil Nadu 638009',
    maps: 'https://maps.app.goo.gl/Tyk7GxsqT91yZnd79', status: 'Open Now',
    lat: 11.339, lng: 77.728
  },
  ...
  {
    name: 'Bengaluru (Kapali Mall)', city: 'Bengaluru', state: 'Karnataka', zone: 'south',
    ...
    lat: 12.978, lng: 77.574
  },
  {
    name: 'Bengaluru (Safina Plaza)', city: 'Bengaluru', state: 'Karnataka', zone: 'south',
  ...
  {
    name: 'Hubballi (Vidya Nagar)', city: 'Hubballi', state: 'Karnataka', zone: 'south',
  ...
  /* ── Telangana ──────────────────────────────────────────────── */
  {
    name: 'Secunderabad', city: 'Hyderabad', state: 'Telangana', zone: 'south',
    address: 'Temple Alwal Road, Old Alwal, Beside True Value, Near Ambedkar Statue, Secunderabad, Telangana 500010',
    maps: 'https://maps.app.goo.gl/f626poy1zU2CSFAj9', status: 'Open Now',
    lat: 17.449, lng: 78.498
  },
  {
  ...
  },
  {
    ...
    lat: 17.426, lng: 78.540
  },

  /* ── Kerala ─────────────────────────────────────────────────── */
  {
    name: 'Uchakkada', city: 'Thiruvananthapuram', state: 'Kerala', zone: 'south',
    address: 'Shop No.16-215/1, Pozhiyoor Road, Opposite Gopus Fuels, Uchakkada, Thiruvananthapuram, Kerala 695506',
  ...
  /* ── Goa ─────────────────────────────────────────────────────── */
  {
    name: 'Madgaon', city: 'Goa', state: 'Goa', zone: 'south',
    ...
    lat: 15.274, lng: 73.957
  },

  /* ── West Bengal ────────────────────────────────────────────── */
  {
    name: 'Bhowanipore', city: 'Kolkata', state: 'West Bengal', zone: 'east',
    address: '40a, Chakraberia Road North, Madan Mohan Malaviya Sarani, Jadubabur Bazar, Bhowanipore, Kolkata, West Bengal 700020',
    maps: 'https://maps.app.goo.gl/Ym9MpaoBAAaeaFpQ6', status: 'Open Now',
    lat: 22.532, lng: 88.342
  },
  {
  ...
  {
    name: 'Santoshpur', city: 'Kolkata', state: 'West Bengal', zone: 'east',
    ...
    lat: 22.517, lng: 88.400
  },
  {
    name: 'Howrah', city: 'Howrah', state: 'West Bengal', zone: 'east',
    address: '24/25, Dobson Road, Near Howrah AC market, Babudanga, Mali Panchghara, Howrah, West Bengal 711101',
    maps: 'https://maps.app.goo.gl/cT4kMpRkGCwAFikHA', status: 'Open Now',
    lat: 22.582, lng: 88.310
  },
  {
    name: 'Foreshore Road (Howrah)', city: 'Howrah', state: 'West Bengal', zone: 'east',
    ...
    lat: 22.565, lng: 88.315
  },

  /* ── Bihar ──────────────────────────────────────────────────── */
  {
    name: 'Darbhanga', city: 'Darbhanga', state: 'Bihar', zone: 'east',
    address: 'Shop No.78, Near IT chowk, Rajkumarganj, Kathalbari, Darbhanga, 846004',
    maps: 'https://maps.app.goo.gl/wruQRXs56rmP76nX8', status: 'Open Now',
    lat: 26.152, lng: 85.901
  },
  {
    name: 'Kidwaipuri (Patna)', city: 'Patna', state: 'Bihar', zone: 'east',
    address: 'SHOP NO.8, YOGENDRA COMPLEX 34, Shri Brij Bihari Prasad Path, Kidwaipuri, Patna, Bihar 800001',
    maps: 'https://maps.app.goo.gl/2FBVyaqk5yuwPbXFA', status: 'Open Now',
    lat: 25.610, lng: 85.090
  },
  {
    name: 'Danapur (Patna)', city: 'Patna', state: 'Bihar', zone: 'east',
  ...
  /* ── Jharkhand ──────────────────────────────────────────────── */
  {
    ...
    address: 'LG-01, Beside Goods \'n Foods, The Hub, Saraidhela, Dhanbad, Jharkhand 828127',
    maps: 'https://maps.app.goo.gl/nUUHTgE9A6pF2LLN7', status: 'Open Now',
    lat: 23.796, lng: 86.429
  },
  {
  ...
  /* ── Rajasthan ──────────────────────────────────────────────── */
  {
    ...
    lat: 28.022, lng: 73.312
  },
  {
    name: 'Jodhpur (Sardarpura)', city: 'Jodhpur', state: 'Rajasthan', zone: 'north',
  ...
  },
  {
    ...
    lat: 29.583, lng: 74.326
  },
  {
    name: 'Jaipur (Rangoli Plaza)', city: 'Jaipur', state: 'Rajasthan', zone: 'north',
    ...
    lat: 26.930, lng: 75.817
  },
  {
    name: 'Jaipur (Raja Park)', city: 'Jaipur', state: 'Rajasthan', zone: 'north',
  ...
  },
  {
    ...
    maps: 'https://share.google/YeQ8AGWq2Pj8kRdav', status: 'Coming Soon',
    lat: 26.451, lng: 74.639
  },

  /* ── Punjab ─────────────────────────────────────────────────── */
  {
    name: 'Amritsar (Golden Temple Road)', city: 'Amritsar', state: 'Punjab', zone: 'north',
  ...
  },
  {
    ...
    address: 'Shop No.90, Ground Floor, NH 44, Opposite to Rudransh Fuels Indian Oil, Pathankot, Punjab 145001',
    maps: 'https://maps.app.goo.gl/2qu2Yrazri67zES48', status: 'Coming Soon',
    lat: 32.274, lng: 75.652
  },

  /* ── Haryana ────────────────────────────────────────────────── */
  {
    name: 'Gurugram (Elan Epic Mall)', city: 'Gurugram', state: 'Haryana', zone: 'north',
    address: 'Shop No. TF-K05 and TG-K06, Elan Epic Mall Food Court, 3rd Floor, Sector 70, Gurugram, Haryana 122101',
    maps: 'https://maps.app.goo.gl/5yprYqPXd4nwSWRL7', status: 'Open Now',
    lat: 28.392, lng: 77.050
  },
  {
    name: 'Gurugram (DevGn Cinex)', city: 'Gurugram', state: 'Haryana', zone: 'north',
    address: 'Kiosk No 4, Outside Audi No: 2 of Devgn CineX, 3rd floor, Elan Epic Mall, Sector 70, Gurugram, Haryana 122101',
    maps: 'https://maps.app.goo.gl/5ZguZSnKwfmxbRaD7', status: 'Open Now',
    lat: 28.393, lng: 77.051
  },
  ...
  /* ── Uttar Pradesh ──────────────────────────────────────────── */
  {
    ...
    lat: 25.144, lng: 82.569
  },
  {
    name: 'Noida', city: 'Noida', state: 'Uttar Pradesh', zone: 'north',
  ...
  /* ── Madhya Pradesh ─────────────────────────────────────────── */
  {
    name: 'Ujjain', city: 'Ujjain', state: 'Madhya Pradesh', zone: 'north',
    ...
    lat: 23.179, lng: 75.784
  },

  /* ── Himachal Pradesh ───────────────────────────────────────── */
  {
    name: 'Jabli (Solan)', city: 'Solan', state: 'Himachal Pradesh', zone: 'north',
    ...
    lat: 31.020, lng: 77.020
  },

  /* ── Maharashtra ────────────────────────────────────────────── */
  {
    name: 'Mumbai (Churchgate)', city: 'Mumbai', state: 'Maharashtra', zone: 'west',
    ...
    lat: 18.935, lng: 72.826
  },
  {
    name: 'Nagpur (Dharampeth)', city: 'Nagpur', state: 'Maharashtra', zone: 'west',
    address: '76 buty plots, Dharampeth, Nagpur, Maharashtra 440010',
    maps: 'https://maps.app.goo.gl/SBjCKg6jhif7ptbb8', status: 'Open Now',
    lat: 21.145, lng: 79.086
  },
  {
    name: 'Pune (Wakad)', city: 'Pune', state: 'Maharashtra', zone: 'west',
    ...
    lat: 18.600, lng: 73.758
  },
  {
    name: 'Pune (Kharadi)', city: 'Pune', state: 'Maharashtra', zone: 'west',
    ...
    lat: 18.556, lng: 73.944
  },
  {
    name: 'Pune (Phursungi)', city: 'Pune', state: 'Maharashtra', zone: 'west',
    ...
    lat: 18.473, lng: 73.936
  },
  {
    name: 'Pune (Ravet)', city: 'Pune', state: 'Maharashtra', zone: 'west',
    ...
    lat: 18.649, lng: 73.741
  },
  {
    name: 'Pune (Moshi)', city: 'Pune', state: 'Maharashtra', zone: 'west',
    ...
    lat: 18.669, lng: 73.834
  },
  {
    name: 'Pune (Indrayani Nagar)', city: 'Pune', state: 'Maharashtra', zone: 'west',
    ...
    lat: 18.638, lng: 73.839
  },
  {
    name: 'Pune (Pimple Saudagar)', city: 'Pune', state: 'Maharashtra', zone: 'west',
    address: 'Shop no: 3, Sai Angan Building, Kunal Icon Road, Pimple Saudagar, Pune, Maharashtra 411027',
    maps: 'https://maps.app.goo.gl/RmHxY5M3srrVd6B68', status: 'Open Now',
    lat: 18.595, lng: 73.805
  },
  {
    name: 'Pune (Kothrud)', city: 'Pune', state: 'Maharashtra', zone: 'west',
    ...
    lat: 18.503, lng: 73.808
  },
  {
    name: 'Pune (Nigdi)', city: 'Pune', state: 'Maharashtra', zone: 'west',
    ...
    lat: 18.651, lng: 73.780
  },
  {
    name: 'Pune (Pashan)', city: 'Pune', state: 'Maharashtra', zone: 'west',
    ...
    lat: 18.522, lng: 73.807
  },
  {
    name: 'Pune (Tathawade)', city: 'Pune', state: 'Maharashtra', zone: 'west',
    ...
    lat: 18.619, lng: 73.769
  },
  {
    name: 'Navi Mumbai (Nerul)', city: 'Navi Mumbai', state: 'Maharashtra', zone: 'west',
  ...
  },
  {
    ...
    lat: 17.688, lng: 75.903
  },
  {
    name: 'Chhatrapati Sambhajinagar', city: 'Chhatrapati Sambhajinagar', state: 'Maharashtra', zone: 'west',
    address: 'Adinath Presidio, Shop no 2, Golvalkar Guruji Marg, Opposite Renuka Gas Agency, Shivaji Nagar, Garkheda Area, Ulkanagari, Chhatrapati Sambhajinagar, Maharashtra 431009',
    maps: 'https://maps.app.goo.gl/mRtGFDKU2ehrje8i9', status: 'Open Now',
    lat: 19.878, lng: 75.342
  },
  {
  ...
  {
    name: 'Yavatmal', city: 'Yavatmal', state: 'Maharashtra', zone: 'west',
    address: 'Shop No G3, Nagar Parishad Complex, Opposite Nagar Bhawan, Panch Kandil Chauk, Yavatmal, Maharashtra 445001',
    maps: 'https://maps.app.goo.gl/TUFf8LeJ66ZAisdK8', status: 'Coming Soon',
    lat: 20.389, lng: 78.120
  },

  /* ── Gujarat ────────────────────────────────────────────────── */
  {
    name: 'Anand (Vallabh Vidyanagar)', city: 'Anand', state: 'Gujarat', zone: 'west',
    ...
    lat: 22.562, lng: 72.924
  },
  {
    name: 'Anand (Vidhyanagar Road)', city: 'Anand', state: 'Gujarat', zone: 'west',
    ...
    lat: 22.556, lng: 72.952
  },
  {
    name: 'Surat', city: 'Surat', state: 'Gujarat', zone: 'west',
    address: 'Shop No. 5, Ground Floor, Oberon Business Complex, New City Light Road, Surat, Gujarat 395017',
